...
This script speed up the pre-shared key sync validation among each sites, so that we can save the time for narrowing down inter-site cloudsec connectivity issues.
